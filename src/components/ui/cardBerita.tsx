...
export default function CardBerita( {title, image, date, author, href, description, classname}: CardBeritaProps ) {
    ...
    return (
        <Link
            href={href}
            className={`flex ${classname} p-4 rounded-lg shadow-md dark:shadow-slate-700 my-4 w-[350px] h-[322px] hover:shadow-xl border border-transparent dark:hover:border-gray-600 hover:border hover:border-gray-400 transition-shadow duration-300`}
        >
